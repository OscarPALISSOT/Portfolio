...
const Card = ({experience}: CardProps) => {
    return (
        <Link href={"/experience/" + experience.id}>
            <div
                className={'mx-3 w-[300px] lg:w-[400px] 2xl:w-[500px] border border-border rounded-xl shadow-md hover:shadow-lg transition duration-300 overflow-hidden cursor-pointer hover:scale-[102%]'}>
