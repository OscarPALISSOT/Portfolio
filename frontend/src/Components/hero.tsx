...
const HeroBlock =({heroBlock}: HeroBlockProps) => {
    return (
        <div className={"flex flex-col lg:flex-row lg:items-center lg:gap-6 my-3"}>
            <div className={"flex flex-col lg:w-2/3"}>
                ...
                <Image className={"lg:hidden w-full mb-3"} src={process.env.NEXT_PUBLIC_ASSETS_URL + heroBlock.image} alt="Oscar PALISSOT" width={500} height={420}/>
            ...
            <div className={"flex justify-center items-center lg:w-1/3"}>
                <Image className={"hidden lg:block w-full"} src={process.env.NEXT_PUBLIC_ASSETS_URL + heroBlock.image} alt="Oscar PALISSOT" width={500} height={420}/>
            </div>
        </div>
    )
}
