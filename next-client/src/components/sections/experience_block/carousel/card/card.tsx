...
const Card = ({experience}: CardProps) => {
    return (
        <div className={'w-[300px] lg:w-[400px] border border-border rounded-xl shadow-md hover:shadow-lg transition duration-300 overflow-hidden cursor-pointer hover:scale-[102%]'}>
